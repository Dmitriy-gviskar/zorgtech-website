...
.h1{font-family:'Inter',ui-sans-serif;font-size:40px;font-weight:600;color:var(--tx);letter-spacing:-0.28px;line-height:1.1;margin-bottom:20px}
.price{font-size:21px;font-weight:400;color:var(--tx2);white-space:nowrap}
.lead{font-size:21px;font-weight:400;color:var(--tx2);line-height:1.38;letter-spacing:0.011em;max-width:440px;margin-bottom:32px}
...
.btn{display:inline-flex;align-items:center;justify-content:center;padding:14px 32px;font-family:'Inter',ui-sans-serif;font-size:17px;font-weight:400;border-radius:9999px;text-decoration:none;transition:background .2s;border:none;background:var(--acc);color:#fff;cursor:pointer}.btn:hover{background:#0077ed}
...
@media(max-width:640px){.nav-links{display:none}.menu-btn{display:block}.page{padding:80px 20px 40px}.h1{font-size:32px}}"""
